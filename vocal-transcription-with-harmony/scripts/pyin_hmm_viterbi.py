...
class ExperimentConfig:
    ...
    min_note_duration: float = 0.3      # Minimum note length (seconds)
    ...
    onset_tolerance: float = 0.1        # Seconds - onset matching tolerance
    pitch_tolerance: float = 100        # Cents - pitch matching tolerance
    ...
    self_trans_prob: float = 0.85      # Stay in same pitch state
    neighbor_prob: float = 0.06        # Move to adjacent pitch
